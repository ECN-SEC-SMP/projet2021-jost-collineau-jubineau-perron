...
TpMonop: main.o
	g++ -o TpMonop main.o joueur.o case.o plateau.o constructible.o achetable.o gare.o service.o non_achetable.o
	rm *.o

main.o: main.cpp joueur.o case.o plateau.o achetable.o constructible.o gare.o service.o non_achetable.o
	g++ -c main.cpp
